...
const order = ["ФИО", "телефон", "Электронная почта"];
...
<template>
  <div class="container mt-10">
    <div class="flex justify-between mb-10 items-center">
      <h4 class="font-extralight text-[40px] max-md:text-[28px]">Корзина</h4>
    </div>
    ...
    <div v-else class="text-9xl text-primary/50 py-40 font-bold">
      <p class="text-center font-extralight">No Products</p>
    </div>
